                ...
                <div class="col ps-4">
                                ...
                                <div class="card-body">
                                    <div class="d-flex justify-content-between align-items-start">
                                        <div class="ms-2 me-auto">
                                            <div class="fw-bold"><i class="bi bi-person-lines-fill me-3"></i> Total Estudiantes</div>
                                        </div>
                        ...
                        <div class="col">
                            <div class="card rounded-pill">
                                <div class="card-body">
                                    <div class="d-flex justify-content-between align-items-start">
                                        <div class="ms-2 me-auto">
                                            <div class="fw-bold"><i class="bi bi-person-lines-fill me-3"></i> Total Profesores</div>
                                        </div>
                        ...
                        <div class="col">
                            <div class="card rounded-pill">
                                <div class="card-body">
                                    <div class="d-flex justify-content-between align-items-start">
                                        <div class="ms-2 me-auto">
                                            <div class="fw-bold"><i class="bi bi-diagram-3 me-3"></i> Total Secciones</div>
                                        </div>
                    ...
                    <div class="mt-3 d-flex align-items-center">
                        <div class="col-3">
                            ...
                            <span class="badge rounded-pill border" style="background-color: #0678c8;">Masculino</span>
                            <span class="badge rounded-pill border" style="background-color: #49a4fe;">Femenino</span>
                        </div>
                        @php
                    ...
                    <div class="row align-items-md-stretch mt-4">
                        <div class="col">
                            <div class="p-3 text-white bg-dark rounded-3">
                                <h3>Bienvenico a Mi colegio!</h3>
                                <p><i class="bi bi-emoji-heart-eyes"></i> Gracias por tu apoyo y soporte.</p>
                            </div>
                        </div>
                        <div class="col">
                            <div class="p-3 bg-white border rounded-3" style="height: 100%;">
                                <h3>Mi colegio es mejor Manejar</h3>
                                <p class="text-end">Con <i class="bi bi-lightning"></i> <a href="/" target="_blank" style="text-decoration: none;">Mi colegio</a> <i class="bi bi-lightning"></i>.</p>
                            </div>
                        </div>
                    </div>
                    <div class="row mt-4">
                                ...
                                <div class="card-body p-0 text-dark">
                                    <div>
                                        ...
                                        <div class="accordion accordion-flush" id="noticeAccordion">
                                            ...
                                            @endisset
                                            @if(count($notices) < 1)
                                                <div class="p-3">Sin noticias a mostrar</div>
                                            @endif
                                        </div>
                                    </div>
                                </div>
